...
public class RegisterPortalOperationClientImpl {
    ...
    public ProductListDTO getProducts(Integer page, Integer size, String sort, String category, String brand, String model, String eprelCode, String gtinCode, String productFileId, String productName, ProductStatus status, String organizationId) {
        return productsApi.getProducts(page, size, sort, category, brand, model, eprelCode, gtinCode, productFileId, productName, status, organizationId);
    }
