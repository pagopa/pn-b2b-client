...
import it.pagopa.interop.attribute.service.IM2MV3CertifiedAttributeClient;
...
public class M2MV3CertifiedAttributeClientImpl extends AbstractClient implements
    IM2MV3CertifiedAttributeClient {
    private final AttributesApi attributesApi;
    private final RestTemplate restTemplate;
    private final String basePath;
    private final M2MVersionsMapper mapper;

    public M2MV3CertifiedAttributeClientImpl(
    ...
    public CertifiedAttribute get(UUID id) {
       return this.performOperation(SimpleOperation.of(
               ...
               res -> res
       )).map(this.mapper::mapToV2).orElse(null);
    }
    ...
    public List<CertifiedAttribute> getAll() {
        return this.performOperation(
            SimpleOperation.of(
                ...
                attrs -> mapper.mapToV2(attrs).getResults()))
    ...
    public CertifiedAttribute create(CertifiedAttributeSeed agreementPayload) {
        it.pagopa.interop.generated.openapi.clients.m2mGatewayV3.model.CertifiedAttributeSeed v3Payload = mapper.mapToV3(agreementPayload);
        return this.performOperation(SimpleOperation.of(
            () -> this.attributesApi.createCertifiedAttribute(v3Payload),
            res -> res
    ...
    public void setHeaders(Map<String, String> headers) {
        this.attributesApi.setApiClient(ApiClientUtils.createApiClient(restTemplate, basePath, headers));
    }
}
