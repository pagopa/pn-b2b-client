...
public class TenantsProcessApiClientImpl implements ITenantsProcessApi {
    ...
    // Client da usare per le apis di maintenance, che richiedono uno specifico token di autenticazione
    ...
    public TenantsProcessApiClientImpl(
        ...
        // Il token per le apis di maintenance è diverso, e indipendente dai ruoli bff
    ...
    public ResponseEntity<Void> maintenanceTenantUpdate(String xCorrelationId, UUID organizationId, MaintenanceTenantUpdatePayload mapped) {
        return processMaintTenantApi.maintenanceTenantUpdateWithHttpInfo(xCorrelationId, organizationId, mapped);
    }
