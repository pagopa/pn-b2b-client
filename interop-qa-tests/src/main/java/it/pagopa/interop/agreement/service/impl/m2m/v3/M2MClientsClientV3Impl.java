package it.pagopa.interop.agreement.service.impl.m2m.v3;

import it.pagopa.interop.agreement.service.m2m.v3.IM2MClientsClientV3;
...
public class M2MClientsClientV3Impl implements IM2MClientsClientV3 {
    private final ClientsApi clientsApi;
    private final RestTemplate restTemplate;
    private final String basePath;

    public M2MClientsClientV3Impl(RestTemplate restTemplate, InteropClientConfigs interopClientConfigs) {
