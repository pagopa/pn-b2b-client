...
@ConfigurationParameters({
        @ConfigurationParameter(
                ...
                value = "pretty," +
                        "json:target/cucumber-report-adeg-analisi-rischio.json," +
                        "html:target/cucumber-report-adeg-analisi-rischio.html," +
        ...
        @ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@test_22092026")
})
@ExcludeTags({"wait_for_fix", "ignore"})
@IncludeTags({"adeguamento-analisi-rischio"})
public class AdeguamentoAnalisiRischioTestConflicts {
}
