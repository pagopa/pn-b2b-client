package it.pagopa.pn.interop.cucumber.steps.archiviazione_documentale.file_processing.strategy.auth;
...
public class ClientDeletedEventStrategy implements FileMatchingStrategy {
    @Override
