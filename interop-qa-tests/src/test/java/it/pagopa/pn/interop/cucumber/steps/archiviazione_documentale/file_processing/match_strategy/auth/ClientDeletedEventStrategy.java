package it.pagopa.pn.interop.cucumber.steps.archiviazione_documentale.file_processing.match_strategy.auth;
...
public class ClientDeletedEventStrategy implements IFileMatcher {
    @Override
