...
public class DefaultEventValidator implements IFileValidator {
    ...
    public void validate(ValidatorStrategySeed seed) throws IOException {
        ...
        String expectedId = seed.getTokenResolver().resolve(":agreementId");
            ...
            FileUtils.validateNdjson(
                    ...
                    json ->
                            json.has("event_name") &&
                                    ...
                                    json.has("id") &&
                                    expectedId.equals(json.get("id").asText()),
                    ...
                    "File %s associato all'evento AgreementActivated non presenta l'id atteso: %s"
                            .formatted(seed.getFile().getFilename(), expectedId)
            );
        }
    }
