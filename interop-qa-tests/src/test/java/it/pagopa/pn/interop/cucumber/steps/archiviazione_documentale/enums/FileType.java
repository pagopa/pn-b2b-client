...
public enum FileType {
    ...
    PURPOSE_ACTIVATED_SIGNED("pdf", PDF_SIGNED_NAME_REGEX),
    NEW_PURPOSE_VERSION_ACTIVATED("pdf", PDF_NAME_REGEX),
    NEW_PURPOSE_VERSION_ACTIVATED_SIGNED("pdf", PDF_SIGNED_NAME_REGEX),
    PURPOSE_VERSION_ACTIVATED("pdf", PDF_NAME_REGEX),
    PURPOSE_VERSION_ACTIVATED_SIGNED("pdf", PDF_SIGNED_NAME_REGEX),
    ...
    AGREEMENT_ACTIVATED_EVENT("gz", EVENT_NAME_REGEX),
    AGREEMENT_ACTIVATED_EVENT_SIGNED("p7m", EVENT_SIGNED_NAME_REGEX),
