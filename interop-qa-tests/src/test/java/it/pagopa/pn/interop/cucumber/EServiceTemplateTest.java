...
@ConfigurationParameters({
        @ConfigurationParameter(
                ...
                value = "pretty," +
                        "json:target/cucumber-report-nrt-eservice-template-bff-m2mv2.json," +
                        "html:target/cucumber-report-nrt-eservice-template-bff-m2mv2.html," +
