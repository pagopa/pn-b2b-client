...
public class EserviceVerifiedAttributesSteps {
    ...
    @Given("l'utente crea un gruppo di attributi contenente {int} attribut(o)(i) verificat(o)(i) con successo")
    ...
    @When("l'utente tenta di aggiungere l'attributo verificato numero {collectionIndex} al gruppo dell'e-service")
    ...
    @When("l'utente tenta di aggiungere l'attributo verificato numero {collectionIndex} al gruppo dell'e-service indicando un e-service id inesistente")
    ...
    @When("l'utente tenta di aggiungere l'attributo verificato numero {collectionIndex} al gruppo dell'e-service indicando un descriptor id inesistente")
    ...
    @When("l'utente tenta di aggiungere l'attributo verificato numero {collectionIndex} al gruppo dell'e-service indicando un group index inesistente")
    ...
    @When("l'utente tenta di rimuovere l'attributo verificato numero {collectionIndex} dal gruppo dell'e-service")
    ...
    @Then("è stato rimosso dall'e-service solo l'attributo verificato numero {collectionIndex}")
    ...
    @Given("l'utente rimuove l'attributo verificato numero {collectionIndex} dal gruppo dell'e-service con successo")
    ...
    @When("l'utente tenta di rimuovere l'attributo verificato numero {collectionIndex} dal gruppo dell'e-service indicando un e-service id inesistente")
    ...
    @When("l'utente tenta di rimuovere l'attributo verificato numero {collectionIndex} dal gruppo dell'e-service indicando un descriptor id inesistente")
    ...
    @When("l'utente tenta di rimuovere l'attributo verificato numero {collectionIndex} dal gruppo dell'e-service indicando un group index inesistente")
