package it.pagopa.pn.interop.cucumber.steps.archiviazione_documentale.file_processing.strategy.delegation;
...
public class ConsumerDelegationApprovedEventStrategy implements FileMatchingStrategy {
    @Override
    public boolean match(MatchingStrategySeed seed) throws IOException {
        //TODO: trovare gli id da leggere all'interno del file
        return FileUtils.ndjsonContainsAll(S3Utils.getFileStream(seed.getS3(), seed.getBucketName()), null);
    }
}
