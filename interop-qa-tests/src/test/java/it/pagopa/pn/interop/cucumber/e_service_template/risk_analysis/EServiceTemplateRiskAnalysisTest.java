package it.pagopa.pn.interop.cucumber.e_service_template.risk_analysis;
...
@IncludeTags({
    EServiceTemplateRiskAnalysisDeleteTest.TAG,
    EServiceTemplateRiskAnalysisAddTest.TAG,
    EServiceTemplateRiskAnalysisUpdateTest.TAG
})
public class EServiceTemplateRiskAnalysisTest extends AbstractEServiceTemplateTest {
}