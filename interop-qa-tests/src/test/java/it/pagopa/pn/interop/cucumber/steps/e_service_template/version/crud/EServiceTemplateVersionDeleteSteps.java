...
public class EServiceTemplateVersionDeleteSteps {
    ...
    public void deleteEServiceTemplateVersionSuccessfully() {
        ...
        this.lastDeletedVersion = sharedStepsContext.getEServiceTemplateStepContext().getLastTemplateManaged().getLastVersionId();
    }
    ...
    public void deleteUnspecifiedEServiceTemplateVersion() {
        ...
        deleteEServiceTemplateVersion(sharedStepsContext.getEServiceTemplateStepContext().getLastTemplateManaged().getId(), null);
    }
    ...
    public void deleteNonExistentEServiceTemplateVersion() {
        deleteEServiceTemplateVersion(sharedStepsContext.getEServiceTemplateStepContext().getLastTemplateManaged().getId(), UUID.randomUUID());
    }
