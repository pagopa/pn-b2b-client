...
Feature: Creazione versione di un e-service
  ...
  Scenario: [DESCRIPTOR_CREATION_1] Un utente autorizzato a creare un e-service crea una versione di un e-service
  ...
  Scenario: [DESCRIPTOR_CREATION_2] Un utente autorizzato vuole creare una versione di e-service avendone già una in bozza
    Given l'utente è un "admin" di "PA1"
    Given l'utente ha già creato un e-service contenente anche il primo descrittore
    When l'utente crea una versione in bozza per quell'e-service
