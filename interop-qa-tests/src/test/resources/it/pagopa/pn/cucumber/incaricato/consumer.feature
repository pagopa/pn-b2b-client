...
#      | support     |        403 |
    ...
    @happy-path @deleghe1 @failed-nrt-03112025 @associa-finalita-client
    ...
    @sad-path @deleghe1 @failed-nrt-03112025 @associa-finalita-client
...
#    And l'utente è un "admin" dell'ente delegante
  ...
  # Ticket aperto https://pagopa.atlassian.net/browse/QA-9270
  @happy-path @deleghe1 @failed-nrt-03112025
