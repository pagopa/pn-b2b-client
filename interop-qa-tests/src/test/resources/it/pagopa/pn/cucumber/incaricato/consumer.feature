...
#      | support     |        403 |
    ...
    @happy-path @delega-fruizione @associa-finalita-client
    ...
    @sad-path @delega-fruizione @associa-finalita-client
...
#    And l'utente è un "admin" dell'ente delegante
  ...
  @hotfix_QA-13870 @delega-fruizione
