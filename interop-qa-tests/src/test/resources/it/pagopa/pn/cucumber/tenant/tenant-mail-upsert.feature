...
Feature: Aggiunta o aggiornamento di una mail di contatto
  ...
  Scenario: Per un utente con sufficienti permessi (admin), alla richiesta di aggiunta della stessa mail di contatto già presente, si ottiene un errore.
    Given l'utente è un "admin" di "PA1"
    Given "PA1" ha già inserito una mail di contatto
