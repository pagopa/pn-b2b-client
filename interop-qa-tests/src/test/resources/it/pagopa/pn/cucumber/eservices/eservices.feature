Feature: Gestione degli eServices
  ...
  Scenario Outline: [M2MG_ESERVICES_1] La lista degli eServices può essere visionata da un utente con ruolo M2M o M2M-ADMIN (Scenario 4)
  ...
  Scenario: [M2MG_ESERVICES_2] Recupero corretto della lista degli eServices con utente autorizzato (Scenario 81)
  ...
  Scenario: [M2MG_ESERVICES_3] Accesso negato alla lista degli eServices con token non valido (Scenario 82)
    Given l'utente è un "admin" di "PA1" con ruolo M2M "m2m"
  ...
  Scenario Outline: [M2MG_ESERVICES_9] La lista dei descriptors di un eService può essere visualizzata da un utente con ruolo M2M o M2M-ADMIN (Scenario 6)
    Given l'utente è un "<ruolo>" di "PA1" con ruolo M2M <ruolo-m2m>
    And l'utente è amministratore del client
    And viene effettuata la creazione degli eServices:
      | eserviceId      | name     |
  ...
  Scenario: [M2MG_ESERVICES_9] Recupero corretto della lista dei descriptors per un eService con utente autorizzato (Scenario 87)
    Given l'utente è un "admin" di "PA1" con ruolo M2M "m2m"
    And l'utente è amministratore del client
    And viene effettuata la creazione degli eServices:
      | eserviceId      | name     |
  ...
  Scenario: [M2MG_ESERVICES_10] Accesso negato alla lista dei descriptors con eserviceId nullo (Scenario 88)
    Given l'utente è un "admin" di "PA1" con ruolo M2M "m2m"
    And l'utente è amministratore del client
    And viene effettuata la creazione degli eServices:
      | eserviceId      | name     |
  ...
  Scenario: [M2MG_ESERVICES_11] Accesso negato alla lista dei descriptors con token non valido (Scenario 89)
    Given l'utente è un "admin" di "PA1" con ruolo M2M "m2m"
    And l'utente è amministratore del client
    And l'utente possiede un token non valido
    And viene effettuata la creazione degli eServices:
  ...
  Scenario: [M2MG_ESERVICES_12] Errore nel recupero della lista dei descriptors con eserviceId inesistente (Scenario 90)
    Given l'utente è un "admin" di "PA1" con ruolo M2M "m2m"
    And l'utente è amministratore del client
    And viene effettuata la creazione degli eServices:
      | eserviceId      | name     |
