...
#  # Scenario: [KEY_RETRIEVE_INVALID_PURPOSE_STATE_API_CLIENT_DPOP] Dato un client API valido, quando la finalità è in stato non valido allora il recupero della chiave pubblica fallisce con errore invalidPurposeState
#  #   Given l'admin del fruitore "PA1" ha già creato un client di tipo API aggiungendo se stesso come membro e caricando una coppia di chiavi
