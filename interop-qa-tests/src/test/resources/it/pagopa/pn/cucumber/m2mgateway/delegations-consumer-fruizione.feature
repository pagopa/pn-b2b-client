...
Feature: Gestione delle deleghe in fruizione M2M
  ...
  # TODO aggiungere step "con successo" per la creazione delle deleghe
  @m2m-parte2-settembre
  Scenario Outline: [M2M_DELEGATIONS_CONSUMER_01] Un utente con ruolo M2M-ADMIN o M2M può recuperare i dettagli di una delega in erogazione (Parte2#Scenario intorno a 236)
...
#
    ...
    #Given l'ente delegato rifiuta la delega in fruizione
    #When l'utente è un "admin" di "PA1" con ruolo M2M <ruolo>
    #And l'utente tenta di reperire i dettagli della delega in fruizione
    #Then si ottiene lo status code 200
