...
public interface IPnExternalChannelsInternalClient {
    ...
    void sendCourtesyShortMessage(String requestIdx, String xPagopaExtchCxId, DigitalCourtesySmsRequest digitalCourtesySmsRequest) throws RestClientException;

    void sendDigitalCourtesyMessage(String requestIdx, String xPagopaExtchCxId, DigitalCourtesyMailRequest digitalCourtesyMailRequest) throws RestClientException;
}
