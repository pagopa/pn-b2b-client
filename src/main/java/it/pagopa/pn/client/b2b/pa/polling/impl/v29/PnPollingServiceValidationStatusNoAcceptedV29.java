...
@Service(PnPollingStrategy.VALIDATION_STATUS_NO_ACCEPTATION_V29)
@Scope(value = ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class PnPollingServiceValidationStatusNoAcceptedV29 extends PnPollingServiceValidationStatusV29 {

    public PnPollingServiceValidationStatusNoAcceptedV29(IPnPaB2bClient b2bClient, TimingForPolling timingForPolling) {
