...
@Service(PnPollingStrategy.VALIDATION_STATUS_NO_ACCEPTATION_V30)
@Scope(value = ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class PnPollingServiceValidationStatusNoAcceptedV30 extends PnPollingServiceValidationStatusV30 {

    public PnPollingServiceValidationStatusNoAcceptedV30(IPnPaB2bClient b2bClient, TimingForPolling timingForPolling) {
