...
import it.pagopa.pn.client.b2b.generated.openapi.clients.external.generate.api.external.bff.recipient.v2.NotificationReceivedApi;
...
public class B2BRecipientExternalClientImpl implements IPnWebRecipientClient {
    ...
    //private final RecipientReadB2BApi recipientReadB2BApi;/TODO VAS IMPORTANTE
...
//        this.recipientReadB2BApi = new RecipientReadB2BApi(newApiClient(restTemplate, webBasePath, gherkinSrlBearerToken));//TODO VAS IMPORTANTE
        this.notificationReceivedApi = new NotificationReceivedApi(newApiClient(restTemplate, webBasePath, gherkinSrlBearerToken));
...
//        return recipientReadB2BApi.getReceivedNotificationV26(iun, mandateId);//TODO VAS IMPORTANTE VERY MUCH
        BffFullNotificationV1 notification = notificationReceivedApi.getReceivedNotificationV1(iun, mandateId);
...
//                this.recipientReadB2BApi.setApiClient(newApiClient(restTemplate, webBasePath, marioCucumberBearerToken));
                this.notificationReceivedApi.setApiClient(newApiClient(restTemplate, webBasePath, marioCucumberBearerToken));
...
//                this.recipientReadB2BApi.setApiClient(newApiClient(restTemplate, webBasePath, marioGherkinBearerToken));
                this.notificationReceivedApi.setApiClient(newApiClient(restTemplate, webBasePath, marioGherkinBearerToken));
...
//                this.recipientReadB2BApi.setApiClient(newApiClient(restTemplate, webBasePath, leonardoBearerToken));
                this.notificationReceivedApi.setApiClient(newApiClient(restTemplate, webBasePath, leonardoBearerToken));
...
//                this.recipientReadB2BApi.setApiClient(newApiClient(restTemplate, webBasePath, gherkinSrlBearerToken));
                this.notificationReceivedApi.setApiClient(newApiClient(restTemplate, webBasePath, gherkinSrlBearerToken));
                this.bearerTokenSetted = BearerTokenType.PG_1;
            }
            case PG_2 -> {
                //TODO VAS IMPORTANTE
//                this.recipientReadB2BApi.setApiClient(newApiClient(restTemplate, b2bBasePath, cucumberSpaBearerToken));
                this.notificationReceivedApi.setApiClient(newApiClient(restTemplate, webBasePath, cucumberSpaBearerToken));
