...
//        this.recipientReadB2BApi = new RecipientReadB2BApi(newApiClient(restTemplate, webBasePath, gherkinSrlBearerToken));//TODO VAS IMPORTANTE
        this.notificationReceivedApi = new NotificationReceivedApi(newNotificationReceivedApiClient(restTemplate, webBasePath, gherkinSrlBearerToken));
    ...
    private static it.pagopa.pn.client.b2b.generated.openapi.clients.external.generate.api.external.bff.recipient.ApiClient newNotificationReceivedApiClient(RestTemplate restTemplate, String basePath, String bearerToken) {
        it.pagopa.pn.client.b2b.generated.openapi.clients.external.generate.api.external.bff.recipient.ApiClient newApiClient =
                new it.pagopa.pn.client.b2b.generated.openapi.clients.external.generate.api.external.bff.recipient.ApiClient(restTemplate);
        newApiClient.setBasePath(basePath);
//        newApiClient.setBearerToken(bearerToken);//TODO VAS IMPORTANTE
        return newApiClient;
    }
...
//        return recipientReadB2BApi.getReceivedNotificationV26(iun, mandateId);//TODO VAS IMPORTANTE
