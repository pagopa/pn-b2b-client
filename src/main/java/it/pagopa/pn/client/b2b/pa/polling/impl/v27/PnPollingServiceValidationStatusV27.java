...
@Service(PnPollingStrategy.VALIDATION_STATUS_V27)
...
public class PnPollingServiceValidationStatusV27 extends PnPollingTemplate<PnPollingResponseV27> {
    ...
    @Override
    protected Predicate<PnPollingResponseV27> checkCondition(String id, PnPollingParameter pnPollingParameter) {
        return pnPollingResponse -> {
