...
import it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.api_v26.EventsApi;
import it.pagopa.pn.client.b2b.webhook.generated.openapi.clients.externalb2bwebhook.api_v26.StreamsApi;
...
@Component
@Slf4j
public class WebhookClientV26 extends AbstractWebhookClient {
    private final EventsApi eventsApi;
    private final StreamsApi streamsApi;

    public WebhookClientV26(RestTemplate restTemplate, InteropTokenSingleton interopTokenSingleton,
    ...
    public StreamMetadataResponseV26 createEventStream(StreamCreationRequestV26 streamCreationRequest) {
        refreshAndSetTokenInteropClient();
        return this.streamsApi.createEventStreamV26(streamCreationRequest);
    }

    public void deleteEventStream(UUID streamId) {
        refreshAndSetTokenInteropClient();
        this.streamsApi.removeEventStreamV26(streamId);
    }

    public StreamMetadataResponseV26 retrieveEventStream(UUID streamId) {
        refreshAndSetTokenInteropClient();
        return this.streamsApi.retrieveEventStreamV26(streamId);
    }

    public List<StreamListElement> listEventStreams() {
        refreshAndSetTokenInteropClient();
        return this.streamsApi.listEventStreamsV26();
    }

    public StreamMetadataResponseV26 updateEventStream(UUID streamId, StreamRequestV26 streamRequest) {
        refreshAndSetTokenInteropClient();
        return this.streamsApi.updateEventStreamV26(streamId, streamRequest);
    }

    public StreamMetadataResponseV26 disableEventStream(UUID streamId) {
        refreshAndSetTokenInteropClient();
        return this.streamsApi.disableEventStreamV26(streamId);
    }

    public List<ProgressResponseElementV26> consumeEventStream(UUID streamId, String lastEventId) {
        refreshAndSetTokenInteropClient();
        return this.eventsApi.consumeEventStreamV26(streamId, lastEventId);
    }

    public ResponseEntity<List<ProgressResponseElementV26>> consumeEventStreamHttp(UUID streamId, String lastEventId) {
        refreshAndSetTokenInteropClient();
        return this.eventsApi.consumeEventStreamV26WithHttpInfo(streamId, lastEventId);
    }
