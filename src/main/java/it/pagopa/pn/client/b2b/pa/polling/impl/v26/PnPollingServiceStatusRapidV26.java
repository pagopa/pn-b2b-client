...
@Service(PnPollingStrategy.STATUS_RAPID_V26)
@Scope(value = ConfigurableBeanFactory.SCOPE_PROTOTYPE)
@Slf4j
public class PnPollingServiceStatusRapidV26 extends PnPollingTemplate<PnPollingResponseV26> {
    ...
    public PnPollingServiceStatusRapidV26(TimingForPolling timingForPolling, IPnPaB2bClient pnPaB2bClient) {
    ...
    private boolean isEqualStatus(PnPollingResponseV26 pnPollingResponse, PnPollingParameter pnPollingParameter) {
