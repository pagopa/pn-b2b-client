...
public class MandateServiceClientImpl implements IMandateServiceClient {
    ...
    @Override
    public ResponseEntity<MandateDto> createMandateWithHttpInfo(MandateDto mandateDto) throws RestClientException {
        return mandateServiceApi.createMandateWithHttpInfo(mandateDto);
    }
}
