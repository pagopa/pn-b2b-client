...
#      | phase    | phase=NOTIFICATION_CANCELLED |
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @ssrl
  Scenario Outline: [CNF5_MONO_DESTINATARIO_SEND_SIMPLE_REGISTERED_LETTER_PAGOPA_ASYNC] Invio di una notifica mono-destinatario con pagamento/i PagoPA(async) che preveda un elemento SEND_SIMPLE_REGISTERED_LETTER
