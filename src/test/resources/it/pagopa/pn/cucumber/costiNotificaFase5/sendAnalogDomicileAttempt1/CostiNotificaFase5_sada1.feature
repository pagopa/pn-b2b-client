...
#PST: https://pagopa.atlassian.net/wiki/spaces/PN/pages/2849800311/DRAFT+PST+PN-18622+Costi+Notifica+BE+-+fase+5
  ...
  Scenario Outline: [CNF5_MONO_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_1_PAGOPA_SYNC] Invio di una notifica mono-destinatario e mono-pagamento PagoPA(sync) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_1
...
#      | phase    | phase=NOTIFICATION_CANCELLED |
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @sada1
  Scenario Outline: [CNF5_MONO_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_1_PAGOPA_ASYNC] Invio di una notifica mono-destinatario e mono-pagamento PagoPA(async) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_1
...
#      | phase    | phase=NOTIFICATION_CANCELLED |
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @sada1
  Scenario Outline: [CNF5_MONO_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_1_F24_SYNC] Invio di una notifica mono-destinatario e mono-pagamento F24(sync) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_1
    Given viene generata una nuova notifica
      | subject            | test costi notifica fase 5 |
      | senderDenomination | Comune di palermo          |
      | pagoPaIntMode      | SYNC                       |
