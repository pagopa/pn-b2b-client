...
#PST: https://pagopa.atlassian.net/wiki/spaces/PN/pages/2849800311/DRAFT+PST+PN-18622+Costi+Notifica+BE+-+fase+5
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @sada0
  Scenario Outline: [CNF5_MONO_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_0_PAGOPA_ASYNC_MONO_PAY] Invio di una notifica mono-destinatario con pagamento singolo PagoPA(async) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_0
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @sada0
  Scenario Outline: [CNF5_MONO_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_0_PAGOPA_ASYNC_MULTI_PAY] Invio di una notifica mono-destinatario con due pagamenti PagoPA(async) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_0
    Given viene creata una nuova richiesta per istanziare una nuova posizione debitoria per l'ente creditore "77777777777" e amount "100" per "Mario Gherkin" con CF "CLMCST42R12D969Z"
