...
#PST: https://pagopa.atlassian.net/wiki/spaces/PN/pages/2849800311/DRAFT+PST+PN-18622+Costi+Notifica+BE+-+fase+5
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @sada1
  Scenario Outline: [CNF5_MONO_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_1_PAGOPA_ASYNC_MONO_PAY] Invio di una notifica mono-destinatario con pagamento singolo PagoPA(async) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_1
