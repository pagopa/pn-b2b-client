...
#PST: https://pagopa.atlassian.net/wiki/spaces/PN/pages/2849800311/DRAFT+PST+PN-18622+Costi+Notifica+BE+-+fase+5
  ...
  Scenario Outline: [CNF5_MULTI_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_1_PAGOPA_SYNC] Invio di una notifica multi-destinatario con pagamento/i PagoPA(sync) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_1
    ...
    And vengono letti gli eventi fino all'elemento di timeline della notifica "SEND_ANALOG_DOMICILE" al tentativo "ATTEMPT_1" per l'utente 0
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @sada1
  Scenario Outline: [CNF5_MULTI_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_1_PAGOPA_ASYNC_MONO_PAY] Invio di una notifica multi-destinatario con pagamento singolo PagoPA(async) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_1
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @sada1
  Scenario Outline: [CNF5_MULTI_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_1_PAGOPA_ASYNC_MULTI_PAY] Invio di una notifica multi-destinatario con 2 pagamenti PagoPA(async) che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_1
    Given viene creata una nuova richiesta per istanziare una nuova posizione debitoria per l'ente creditore "77777777777" e amount "100" per "Mario Gherkin" con CF "CLMCST42R12D969Z"
  ...
  @costiNotificaFase5 @CNF5_FF_ENABLED @sada1
  Scenario Outline: [CNF5_MULTI_DESTINATARIO_SEND_ANALOG_DOMICILE_ATTEMPT_1_F24] Invio di una notifica multi-destinatario con pagamento/i F24 che preveda un elemento SEND_ANALOG_DOMICILE_ATTEMPT_1
    Given viene generata una nuova notifica
      | subject            | test costi notifica fase 5 |
      | senderDenomination | Comune di palermo          |
      | pagoPaIntMode      | NONE                       |
