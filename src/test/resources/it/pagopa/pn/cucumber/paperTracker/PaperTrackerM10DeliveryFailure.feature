Feature: SEND - Recapito FASE 2: Gestione causale di mancato recapito M10 (Indirizzo non leggibile) e logica di retry analogico
  ...
  Scenario: [MOCK_RECAPITO_M10_02_1_B] TEST 2.1 - Path B: Validazione positiva con mock OCR:KO ma motore OCR disabilitato
    Given viene generata una nuova notifica
      | subject               | invio notifica con cucumber |
      | senderDenomination    | Comune di Palermo           |
      | physicalCommunication | AR_REGISTERED_LETTER        |
  ...
  Scenario: [MOCK_RECAPITO_M10_02_2_B] TEST 2.2 - Path B: Blocco del retry ed emissione errore OCR_VALIDATION con mock OCR:KO e motore OCR abilitato
    Given viene generata una nuova notifica
      | subject               | invio notifica con cucumber |
      | senderDenomination    | Comune di Palermo           |
      | physicalCommunication | AR_REGISTERED_LETTER        |
