Feature: Api Service Cruscotto Assitenza
  ...
  Scenario Outline: [API-SERVICE-CA_CE02.3_17] Invocazione del servizio con taxId vuoto
    ...
    Examples:
      ...
      | VUOTO |   PF         |
   #{"type":null,"status":400,"title":"DATA_VAULT_DECRYPTION_ERROR","detail":"Anonymization service not available ","traceId":"Root=1-65816ea3-194372e76dc1124c04ff6c7b","timestamp":"2023-12-19T10:21:23.542756665Z","errors":[]}"
