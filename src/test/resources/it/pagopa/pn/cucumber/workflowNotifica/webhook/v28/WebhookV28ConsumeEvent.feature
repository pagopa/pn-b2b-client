Feature: avanzamento notifiche webhook b2b V28
  ...
  Scenario: [B2B-STREAM_ES1.3_128] Consumo di uno stream notifica con gruppo, con eventType "TIMELINE"  utilizzando un apikey master.
    ...
    And verifica deanonimizzazione degli eventi di timeline versione "V28" con delega "NO" digitale
  ...
  Scenario: [B2B-STREAM_ES3.1_146_2]  Lettura e verifica de-anonimizzazione con un apiKey con gruppo degli eventi di timeline di una notifica analogica inviata con un apikey con gruppo e salvati in uno stream dell'ente con gruppo (Stesso gruppo)
    ...
    And verifica deanonimizzazione degli eventi di timeline versione "V28" con delega "NO" analogico
    And vengono letti gli eventi dello stream del "Comune_Multi" fino all'elemento di timeline "SEND_ANALOG_DOMICILE" con la versione "V28" e apiKey aggiornata con position 0
    And verifica deanonimizzazione degli eventi di timeline versione "V28" con delega "NO" analogico
    And vengono letti gli eventi dello stream del "Comune_Multi" fino all'elemento di timeline "ANALOG_SUCCESS_WORKFLOW" con la versione "V28" e apiKey aggiornata con position 0
    And verifica deanonimizzazione degli eventi di timeline versione "V28" con delega "NO" analogico
