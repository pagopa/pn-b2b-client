...
#  @sequence.5s-CON080.5s-CON020[DOC:7ZIP;PAGES:3].5s-RECRN010.5s-RECRN011.5s-RECRN004A.5s-RECRN004B[DOC:Plico].5s-RECRN004C"
  ...
  Scenario: [B2B_TIMELINE_ANALOG_GIACENZA_AR_ERR_1] Invio Notifica Mono destinatario workflow cartaceo - Caso FAIL-CompiutaGiacenza_AR_ERR
    ...
    # Con questo controllo si verifica collateralmente che:
    # 1. Non ci siano altri eventi oltre quelli di tipo SEND_ANALOG_PROGRESS
    # 2. Che non ci sia un evento con delivery detail code PNRN012
