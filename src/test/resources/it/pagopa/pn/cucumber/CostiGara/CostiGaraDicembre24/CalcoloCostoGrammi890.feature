Feature: calcolo costo notifica in base hai grammi con notifiche 890
  ...
  Scenario Outline: [CALCOLO-COSTO_890-20GR_1] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso <= 20gr
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-21GR_2] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 21gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>             |
      | senderDenomination    | Comune di palermo     |
      | physicalCommunication | REGISTERED_LETTER_890 |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-50GR_3] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 50gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>             |
      | senderDenomination    | Comune di palermo     |
      | physicalCommunication | REGISTERED_LETTER_890 |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-51GR_4] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 51gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                  |
      | senderDenomination    | Comune di palermo          |
      | physicalCommunication | REGISTERED_LETTER_890      |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-100GR_5] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 100gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                     |
      | senderDenomination    | Comune di palermo                             |
      | physicalCommunication | REGISTERED_LETTER_890                         |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-101GR_6] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 101gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                    |
      | senderDenomination    | Comune di palermo                            |
      | physicalCommunication | REGISTERED_LETTER_890                        |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-250GR_7] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 250gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                                       |
      | senderDenomination    | Comune di palermo                                               |
      | physicalCommunication | REGISTERED_LETTER_890                                           |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-251GR_8] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 251gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                                       |
      | senderDenomination    | Comune di palermo                                               |
      | physicalCommunication | REGISTERED_LETTER_890                                           |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-350GR_9] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 350gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                                        |
      | senderDenomination    | Comune di palermo                                                |
      | physicalCommunication | REGISTERED_LETTER_890                                            |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-351GR_10] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 351gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                                        |
      | senderDenomination    | Comune di palermo                                                |
      | physicalCommunication | REGISTERED_LETTER_890                                            |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-1000GR_11] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 1000gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                                                                        |
      | senderDenomination    | Comune di palermo                                                                                |
      | physicalCommunication | REGISTERED_LETTER_890                                                                            |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-1001GR_12] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 1001gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                                                                        |
      | senderDenomination    | Comune di palermo                                                                                |
      | physicalCommunication | REGISTERED_LETTER_890                                                                            |
  ...
  @costoAnalogicoDicembre24
  Scenario Outline: [CALCOLO-COSTO_890-2000GR_13] (Dicembre) Invio notifica e verifica calcolo del costo su raccomandata con peso = 2000gr
    Given viene generata una nuova notifica
      | subject               | <SUBJECT>                                                                                        |
      | senderDenomination    | Comune di palermo                                                                                |
      | physicalCommunication | REGISTERED_LETTER_890                                                                            |
