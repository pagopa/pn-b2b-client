Feature: Correzione timeline fase 2 costi
  ...
  @timelineReworkF2_costi
  #OK, restart porta di nuovo a OK ad attempt0
  Scenario: [TR3_PAYMENTS_REWORK_9_FLATRATE_OK_AR_1] Invio di una notifica mono-destinatario con pagamento/i PagoPA(flat rate sync) e controllo della corretta valorizzazione dei dati su pn-notificationDeliveryCost in seguito al rework
  ...
  @timelineReworkF2_costi
  #OK, restart porta a deceduto ad attempt0
  Scenario: [TR3_PAYMENTS_REWORK_9_FLATRATE_OK_AR_2] Invio di una notifica mono-destinatario con pagamento/i PagoPA(flat rate sync) e controllo della corretta valorizzazione dei dati su pn-notificationDeliveryCost in seguito al rework
    Given viene generata una nuova notifica
      | subject               | test costi rework    |
      | physicalCommunication | AR_REGISTERED_LETTER |
      | senderDenomination    | Comune di palermo    |
  ...
  @timelineReworkF2_costi
  #OK, restart porta a KO ad attempt0
  Scenario: [TR3_PAYMENTS_REWORK_9_FLATRATE_OK_AR_3] Invio di una notifica mono-destinatario con pagamento/i PagoPA(flat rate sync) e controllo della corretta valorizzazione dei dati su pn-notificationDeliveryCost in seguito al rework
    Given viene generata una nuova notifica
      | subject               | test costi rework    |
      | physicalCommunication | AR_REGISTERED_LETTER |
      | senderDenomination    | Comune di palermo    |
