Feature: Correzione timeline fase 2 costi
  ...
  Scenario Outline: [TR3_PAYMENTS_REWORK_11_DELIVERY_MODE_SYNC] Invio di una notifica mono-destinatario con pagamento/i PagoPA(delivery mode sync) e controllo della corretta valorizzazione dei dati su pn-notificationDeliveryCost in seguito al rework
    ...
    And il baseCost è uguale rispetto a prima del rework
    Examples:
      | sequence                          | finalEvent                         | finalStatus        | attempt | expectedStatusCode | finalEventRestart                  | finalStatusRestart | attemptRestart | deliveryCostEqual |
      | Via@FAIL_DECEDUTO_AR              | ANALOG_WORKFLOW_RECIPIENT_DECEASED | RETURNED_TO_SENDER | 0       | RECRN002C          | ANALOG_WORKFLOW_RECIPIENT_DECEASED | RETURNED_TO_SENDER | 0              | uguale            |
      ...
      | Via@FAIL_DECEDUTO_AR              | ANALOG_WORKFLOW_RECIPIENT_DECEASED | RETURNED_TO_SENDER | 0       | RECRN002F          | ANALOG_FAILURE_WORKFLOW            | EFFECTIVE_DATE     | 1              | differente        |
      | Via@OK_AR                         | ANALOG_SUCCESS_WORKFLOW            | EFFECTIVE_DATE     | 0       | RECRN002C          | ANALOG_WORKFLOW_RECIPIENT_DECEASED | RETURNED_TO_SENDER | 0              | differente        |
      ...
      | Via@OK_AR                         | ANALOG_SUCCESS_WORKFLOW            | EFFECTIVE_DATE     | 0       | RECRN002F          | ANALOG_FAILURE_WORKFLOW            | EFFECTIVE_DATE     | 1              | differente        |
      | Via@FAIL-DISCOVERY_AR             | ANALOG_SUCCESS_WORKFLOW            | EFFECTIVE_DATE     | 1       | RECRN002C          | ANALOG_WORKFLOW_RECIPIENT_DECEASED | RETURNED_TO_SENDER | 0              | differente        |
      ...
      | Via@FAIL-DISCOVERY_AR             | ANALOG_SUCCESS_WORKFLOW            | EFFECTIVE_DATE     | 1       | RECRN002F          | ANALOG_FAILURE_WORKFLOW            | EFFECTIVE_DATE     | 1              | differente        |
      | Via@FAIL-DISCOVERYIRREPERIBILE_AR | ANALOG_FAILURE_WORKFLOW            | EFFECTIVE_DATE     | 1       | RECRN002C          | ANALOG_WORKFLOW_RECIPIENT_DECEASED | RETURNED_TO_SENDER | 0              | differente        |
      ...
      | Via@FAIL-DISCOVERYIRREPERIBILE_AR | ANALOG_FAILURE_WORKFLOW            | EFFECTIVE_DATE     | 1       | RECRN002F          | ANALOG_FAILURE_WORKFLOW            | EFFECTIVE_DATE     | 1              | uguale            |
      #TODO ADD ALL SEQUENCES ONCE THEY ARE CREATED
