Feature: connettore app IO per invio messaggi di cortesia per comunicazioni bonarie
  ...
  Scenario: [IO_CONNECTOR_4.1.1] Verifica raggiungibilità profilo IO da orchestratore con utente non censito su IO
    Given come orchestratore SEND tento la verifica raggiungibilità profilo con senderServiceId valido e CF destinatario: "PF-36b40f4c-f792-40ca-9c52-a94a32b5fc28"
    Then verifico che si ottenga una response di "OK"
...
#      | $NULL     | PF-36b40f4c-f792-40ca-9c52-a94a32b5fc28 |
      | 01KT6TACWT3Q8N3BQV0YHTYNKN | $NULL          |
      | $EMPTY                     | $EMPTY         |
