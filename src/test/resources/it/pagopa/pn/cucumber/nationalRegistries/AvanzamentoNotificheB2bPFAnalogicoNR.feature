...
#  1. CF: XVRPLN98S16L781X sequence: via@FAIL-Irreperibile_890 -> campo Via/Indirizzo non valorizzato;
#  2. CF: XVRCSR87M15L781X sequence: via@FAIL-Irreperibile_890 -> campo Città/Località non valorizzato;
#  3. CF: XVRSFN76E31L781N sequence: via@FAIL-Irreperibile_890 -> campi Via/Indirizzo e Città/Località non valorizzati.

  @workflowAnalogico @mockNR @workflowAnalogicoTMP
