...
@Component
public class InformalPecCommunicationBodyStrategy implements ITemplateEngineStrategy {

    private final ITemplateEngineClient templateEngineClient;
    private final TemplateEngineMessageConfigs configs;

    public InformalPecCommunicationBodyStrategy(ITemplateEngineClient templateEngineClient, TemplateEngineMessageConfigs configs) {
    ...
    public TemplateEngineResult retrieveTemplate(String language, boolean body, TemplateRequestContext context) {
        ...
        String file = templateEngineClient.informalPecCommunicationBody(selectLanguage(language), informalCommunication);
        return new TemplateEngineResult(file);
    }

    @Override
    public String getTextToCheckLanguage(String language, String recipientType) {
        return String.join(" ", getYamlText("informal-pec-communication-body", recipientType, language));
    }

    @Override
    public List<String> getTextsToCheckLanguage(String language, String recipientType) {
        return getYamlText("informal-pec-communication-body", recipientType, language);
    }
