...
public class InvioNotificheB2bSteps {
    ...
    public void controlloCampiAddressNormalizzatore() {
        ...
        TimelineElementV26 timelineNormalizer = timeline.getTimeline().stream().filter(elem -> elem.getCategory().getValue().equals(TimelineElementCategoryV23.NORMALIZED_ADDRESS.getValue())).findAny().orElse(null);
