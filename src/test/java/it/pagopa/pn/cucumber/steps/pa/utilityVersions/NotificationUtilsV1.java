...
public class NotificationUtilsV1 extends AbstractNotificationUtils {

    private NotificationStepsV1 notificationStep;

    public NotificationUtilsV1(NotificationStepsV1 notificationStep) {
