...
public class WebhookStepsV27 implements WebhookStepsInterface {
    ...
    public void updateStreams() {
        ...
        for (StreamMetadataResponseV27 eventStream : eventStreamList) {
            StreamMetadataResponseV27 result = webhookClient.updateEventStreamV27(eventStream.getStreamId(), streamRequest);
    ...
    public void getStreamById(UUID streamId) {
        StreamMetadataResponseV27 eventStream = Assertions.assertDoesNotThrow(() -> webhookClient.retrieveEventStreamV27(streamId));
    ...
    public void consumeEventStream(UUID streamId) {
        progressResponseElementList = webhookClient.consumeEventStreamV27(streamId, null);
    ...
    public void disableStream(UUID streamId) {
        webhookClient.disableEventStreamV27(streamId);
    }
    ...
    public void disableStreams() {
        eventStreamList.forEach(s -> {
            ...
            StreamMetadataResponseV27 response = webhookClient.disableEventStreamV27(streamId);
    ...
    public <T> void verifyAssertionsTimeline(AvanzamentoNotificheWebhookB2bSteps.TimelineElementSearchResult<?> timelineForStream, T progressResponseElement) {
        try {
            ...
            TimelineElementCategoryV26 timelineElementInternalCategory = TimelineElementCategoryV26.valueOf(((TimelineElementCategoryV27) timelineForStream.getTimelineElementCategory()).name());
    ...
    public void getStreamEventListForStressTest() {
        for (StreamMetadataResponseV27 stream : eventStreamList) {
            ...
            List<ProgressResponseElementV27> progressResponseElements = webhookClient.consumeEventStreamV27(streamId, null);
    ...
    public List<Object> verificaCorrispondenzaElementiTimelineWebhookAndB2B() {
        ...
        TimelineElementV26 timelineElement = progressResponseElement.getElement();
        assertThat(timelineElement).as("L'elemento di timeline restituito dal webhook non dev'essere null").isNotNull();

        TimelineElementCategoryV26 timelineElementCategory = timelineElement.getCategory();
        ...
        FullSentNotificationV26 fullSentNotification = getFullSentNotificationVersioned();
        it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementV26 timelineElementB2b = fullSentNotification.getTimeline().
                stream()
        ...
        it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementDetailsV26 timelineElementB2bDetails = timelineElementB2b.getDetails();
    ...
    public void checkCorrectDisabling(UUID streamId) {
        StreamMetadataResponseV27 eventStream = webhookClient.retrieveEventStreamV27(streamId);
