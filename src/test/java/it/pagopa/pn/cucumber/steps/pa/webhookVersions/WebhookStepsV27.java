...
public class WebhookStepsV27 implements WebhookStepsInterface {
    ...
    private ResponseEntity<List<ProgressResponseElementV27>> consumeResponseWithHttpInfo;
    ...
    public void consumeEventStreamWithHttpInfo(UUID streamId) {
        consumeResponseWithHttpInfo = webhookClient.consumeEventStreamHttpV27(streamId, null);
    ...
    public void verifyNoEventsInStream() {
        ...
        assertThat(webhookClient.consumeEventStreamV27(streamId, null)).as("La lista di eventi restituiti dalla consume dovrebbe essere vuota").isEmpty();
    }
