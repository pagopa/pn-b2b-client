...
public class WebhookStepsV10 implements WebhookStepsInterface {
    ...
    //TODO: per futuro refactor//private final WebhookClientV10 webhookClient;
    ...
    public WebhookStepsV10(AvanzamentoNotificheWebhookB2bSteps webhookSteps) {
        ...
        //TODO: per futuro refactor//webhookClient = (WebhookClientV10) webhookSteps.getWebhookClientFactory().getWebhookClientByVersion(streamVersion.getValue());
    ...
    public boolean checkTimeline(AvanzamentoNotificheWebhookB2bSteps.TimelineElementSearchResult<?> timelineForStream) {
        ...
        for (int i = 0; i < timelineForStream.getNumCheck(); i++) {
            ...
            FullSentNotificationV20 fullSentNotification = webhookSteps.getB2bClient().getSentNotificationV2(webhookSteps.getSharedSteps().getNotificationIun());
