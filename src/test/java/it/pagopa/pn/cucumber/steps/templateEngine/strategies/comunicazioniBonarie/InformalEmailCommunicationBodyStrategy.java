...
@Component
public class InformalEmailCommunicationBodyStrategy implements ITemplateEngineStrategy {

    private final ITemplateEngineClient templateEngineClient;
    private final TemplateEngineMessageConfigs configs;

    public InformalEmailCommunicationBodyStrategy(ITemplateEngineClient templateEngineClient, TemplateEngineMessageConfigs configs) {
    ...
    public TemplateEngineResult retrieveTemplate(String language, boolean body, TemplateRequestContext context) {
        ...
        String file = templateEngineClient.informalEmailCommunicationBody(selectLanguage(language), informalCommunication);
        return new TemplateEngineResult(file);
    }

    @Override
    public String getTextToCheckLanguage(String language, String recipientType) {
        return String.join(" ", getYamlText("informal-email-communication-body", recipientType, language));
    }

    @Override
    public List<String> getTextsToCheckLanguage(String language, String recipientType) {
        return getYamlText("informal-email-communication-body", recipientType, language);
    }
