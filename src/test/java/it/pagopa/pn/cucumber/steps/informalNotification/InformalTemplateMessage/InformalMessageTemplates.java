...
public final class InformalMessageTemplates {

    private InformalMessageTemplates() {
    }

    public static final InformalMessageContent SORICAL_IT = new InformalMessageContent("IT", "È stata emessa una nuova fattura per te", """
    ...
    public static final InformalMessageContent SORICAL_FR = new InformalMessageContent("FR", "Une nouvelle facture a ete emise pour vous", """
