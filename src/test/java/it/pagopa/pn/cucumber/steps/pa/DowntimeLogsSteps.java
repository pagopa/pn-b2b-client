...
public class DowntimeLogsSteps {
    ...
    public void vieneChiamataLAPIPerIlDownloadDellAttoOpponibileAiTerziConId(String idType) {
        try {
            // controllare date valide per avere un legalFactId valido
            ...
            String legalFactId = idType.equals("CORRETTO") ? pnDowntimeHistoryResponse.getResult().get(0).getLegalFactId() : "12334567890";
    ...
    public void vieneChiamataLAPIPerIlDownloadDellAttoOpponibileProdottoPiuDiGiorniPrecedenti() {
        try {
            LocalDate date = LocalDate.now();
            LocalDate before = date.minusDays(120);
