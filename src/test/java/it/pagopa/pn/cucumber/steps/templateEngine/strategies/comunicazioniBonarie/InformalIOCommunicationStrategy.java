...
@Component
public class InformalIOCommunicationStrategy implements ITemplateEngineStrategy {

    private final ITemplateEngineClient templateEngineClient;
    private final TemplateEngineMessageConfigs configs;

    public InformalIOCommunicationStrategy(ITemplateEngineClient templateEngineClient, TemplateEngineMessageConfigs configs) {
    ...
    public TemplateEngineResult retrieveTemplate(String language, boolean body, TemplateRequestContext context) {
        ...
        String file = templateEngineClient.informalIoCommunication(selectLanguage(language), informalCommunication);
        return new TemplateEngineResult(file);
    }

    @Override
    public String getTextToCheckLanguage(String language, String recipientType) {
        return String.join(" ", getYamlText("informal-io-communication", recipientType, language));
    }

    @Override
    public List<String> getTextsToCheckLanguage(String language, String recipientType) {
        return getYamlText("informal-io-communication", recipientType, language);
    }
