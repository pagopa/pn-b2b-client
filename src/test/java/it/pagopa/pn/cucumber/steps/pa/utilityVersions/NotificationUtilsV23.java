...
public class NotificationUtilsV23 extends B2bUtils {
    ...
    public NewNotificationResponse uploadNotification(NewNotificationRequestV23 request, String errorType) throws IOException {
    ...
    private NewNotificationRequestV23 addErrorsOnPurpose(NewNotificationRequestV23 request, String errorType) throws IOException {
        if (errorType != null) {
            switch (errorType) {
