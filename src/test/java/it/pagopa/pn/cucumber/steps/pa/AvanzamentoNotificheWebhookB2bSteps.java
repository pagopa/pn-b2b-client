...
public class AvanzamentoNotificheWebhookB2bSteps {
    ...
    private final LinkedList<ProgressResponseElementV25> progressResponseElementListV25 = new LinkedList<>();
    private final LinkedList<ProgressResponseElementV26> progressResponseElementListV26 = new LinkedList<>();
    private final LinkedList<ProgressResponseElementV27> progressResponseElementListV27 = new LinkedList<>();
...
//        }
    ...
    //TODO MATTEO parametrizzare??? di diverso rispetto a quello di sopra ha i filteredValues, che cambia?
    ...
    public void streamBeenRetrievedByStreamId(String version) {
        ...
        try {
            switch (streamVersion) {
                ...
                case V27 -> webhookB2bClient.retrieveEventStreamV27(this.eventStreamListV26.get(0).getStreamId());
            }
        } catch (HttpStatusCodeException e) {
            this.notificationError = e;
            sharedSteps.setNotificationError(e);
    ...
    public void readStreamEventsStateV27(String pa, String status) {
        ...
        for (int i = 0; i < numCheck; i++) {
            ...
            NotificationStatusHistoryElementV26 notificationStatusHistoryElement = sharedSteps.getSentNotification().getNotificationStatusHistory().
                    stream().filter(elem -> elem.getStatus().equals(notificationInternalStatus)).findAny().orElse(null);
            if (notificationStatusHistoryElement != null) {
                finded = true;
                break;
            }
    ...
    public void readStreamTimelineElement(String pa, String timelineEventCategory, String version) {
        ...
        Map<StreamVersion, Function<String, Object>> getTimelineElementInternalCategory = Map.of(
                V23, (timelineElementCategoryName) -> it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementCategoryV23.valueOf(timelineElementCategoryName),
                V26, (timelineElementCategoryName) -> it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementCategoryV26.valueOf(timelineElementCategoryName)
        );
        int numCheck = timelineForStream.getNumCheck();
        int waiting = timelineForStream.getWaiting();
...
//            progressResponseElementResultV23 = progressResponseElement;//TODO MATTEO, ereditato da V23, sembra inutile però
    ...
    public void readStreamTimelineElementAndVerifyDateV27() {
        ...
        OffsetDateTime NotificationTimestamp;
        try {
            Assertions.assertNotNull(progressResponseElementListV27);
            EventTimestamp = progressResponseElementListV27.stream().filter(
    ...
    private <T> PnPollingWebhook getPnPollingWebhook(T timeLineOrStatus) {
        ...
        if (timeLineOrStatus instanceof TimelineElementCategoryV20) {
            ...
            progressResponseElementListV27.clear();
            pnPollingWebhook.setProgressResponseElementListV27(progressResponseElementListV27);
