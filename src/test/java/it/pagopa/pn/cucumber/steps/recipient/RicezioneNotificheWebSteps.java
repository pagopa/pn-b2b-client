...
public class RicezioneNotificheWebSteps {
    ...
    public void downloadLegalFactIdAARByRecipient(String recipient) {
        ...
        it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementCategoryV27 timelineElementInternalCategory = it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementCategoryV27.AAR_GENERATION;
        ...
        if (!timelineElement.getDetails().getGeneratedAarUrl().isEmpty()) {
            ...
            try {
                this.webRecipientClient.getDocumentsWeb(sharedSteps.getNotificationIun(), DocumentCategory.AAR, finalKeySearch, null);
            } catch (HttpStatusCodeException e) {
                this.notificationError = e;
            }
        }
