...
@Slf4j
public class RicezioneNotificheUSAWebSteps {
    ...
    public void beforeMethod() {
        this.iPnWebUserAttributesClient = context.getBean(PnWebUserAttributesInternalClientImpl.class);
        if (!(webRecipientClient instanceof PnWebRecipientExternalClientImpl)) {
            this.webRecipientClient = context.getBean(PnWebRecipientExternalClientImpl.class);
    ...
    @Autowired
    public RicezioneNotificheUSAWebSteps(ApplicationContext context, SharedSteps sharedSteps, PnWebUserAttributesInternalClientImpl iPnWebUserAttributesClient,
    ...
    public void lUtenteControllaAccettazioneDeiTos(String user, String tosStatus) {
        sharedSteps.selectUser(user);
        ConsentType consentType = ConsentType.TOS_SERCQ;
