...
public class NotificationAARForPECStrategy implements ITemplateEngineStrategy {
    ...
    public String getTextToCheckLanguage(String language) {
        return switch (language.toUpperCase()) {
            case  "ITALIANA" -> {
                yield "L&#39;ente mittente conosce questo indirizzo PEC perch&eacute; l&#39;hai inserito nei tuoi recapiti di SEND, perch&eacute; fa parte di uno dei registri previsti dal Codice Amministrazione Digitale o perch&eacute; gliel&#39;hai comunicato in passato. Per modificare i recapiti o aggiungerne altri";
            }
            case "TEDESCA" -> {
            ...
            case "FRANCESE" -> {
                yield "L&#39;entit&eacute; &eacute;mettrice conna&icirc;t cette adresse PEC parce que vous l&#39;avez incluse dans vos coordonn&eacute;es SEND, parce qu&#39;elle fait partie d&#39;un des registres pr&eacute;vus par le Code Administration Num&eacute;rique ou parce que vous la lui avez communiqu&eacute;e dans le pass&eacute;.";
            }
