...
public enum TemplateType {
    ...
    AVVISO_CORTESIA_EMAIL_OBJECT("AVVISO DI CORTESIA PER EMAIL OBJECT"),
    ...
    AVVISO_CORTESIA_EMAIL_DIGITALE("AVVISO DI CORTESIA EMAIL DIGITALE"),
    AVVISO_CORTESIA_SMS_DIGITALE("AVVISO DI CORTESIA SMS DIGITALE"),
    PEC_NON_VALIDA_OBJECT("PEC NON VALIDA OBJECT"),

    COMUNICAZIONE_BONARIA("COMUNICAZIONE BONARIA POSTA CARTACEA"),
    COMUNICAZIONE_BONARIA_EMAIL_BODY("EMAIL BODY COMUNICAZIONE BONARIA"),
    COMUNICAZIONE_BONARIA_EMAIL_SUBJECT("EMAIL SUBJECT COMUNICAZIONE BONARIA"),
    COMUNICAZIONE_BONARIA_PEC_BODY("PEC BODY COMUNICAZIONE BONARIA"),
    COMUNICAZIONE_BONARIA_PEC_SUBJECT("PEC SUBJECT COMUNICAZIONE BONARIA"),
    COMUNICAZIONE_BONARIA_IO("IO COMUNICAZIONE BONARIA"),
    COMUNICAZIONE_BONARIA_SMS("SMS COMUNICAZIONE BONARIA");
