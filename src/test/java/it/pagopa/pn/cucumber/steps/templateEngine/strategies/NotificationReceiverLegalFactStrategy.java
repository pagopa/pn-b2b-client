...
public class NotificationReceiverLegalFactStrategy implements ITemplateEngineStrategy {
    ...
    public String getTextToCheckLanguage(String language, String recipientType) {
        return switch (language.toUpperCase()) {
            ...
            case "TEDESCA" -> {
                yield "emäß Artikel 26, Absatz 11 des Gesetzesdekrets 76/2020 in geltender Fassung BESCHEINIGT PagoPA S.p.A. als rechtmäßiger Betreiber der im selben Artikel 26 genannten Plattform für digitale Zustellungen (auch bekannt als SEND - Servizio Notifiche Digitali), mit jeglicher Rechtskräftigkeit für die Entgegenhaltung gegenüber Dritten, HIERMIT, dass: am string der Absender string, Steuernummer string dem Betreiber die elektronischen Dokumente, die mittels IUN string und nachfolgenden Hashes eindeutig identifizierbar sind zur Verfügung gestellt hat: Ai sensi dell’art. 26, comma 11, del decreto-legge 76/2020 s.m.i., la PagoPA S.p.A. nella sua qualità di gestore ex lege della Piattaforma Notifiche Digitali di cui allo stesso art. 26 (anche nota come SEND - Servizio Notifiche Digitali), con ogni valore legale per l'opponibilità a terzi, ATTESTA CHE";
            }
            case "SLOVENA" -> {
                yield "V skladu z 11. odstavkom 26. člena zakonskega odloka 76/2020 s spremembami, družba PagoPA S.p.A. kot zakoniti upravljavec Platforme za digitalno obveščanje, opredeljene v istem 26. členu (znana tudi kot SEND - Servizio Notifiche Digitali), z vsemi pravnimi učinki za veljavnost do tretjih oseb, POTRJUJE, DA: je string, davčna številka string, dne string dal upravljavcu na voljo elektronske dokumente, navedene v IUN string, ki so identificirani z naslednjimi zgoščenimi vrednostmi (hash): Ai sensi dell’art. 26, comma 11, del decreto-legge 76/2020 s.m.i., la PagoPA S.p.A. nella sua qualità di gestore ex lege della Piattaforma Notifiche Digitali di cui allo stesso art. 26 (anche nota come SEND - Servizio Notifiche Digitali), con ogni valore legale per l'opponibilità a terzi, ATTESTA CHE";
            }
            case "FRANCESE" -> {
