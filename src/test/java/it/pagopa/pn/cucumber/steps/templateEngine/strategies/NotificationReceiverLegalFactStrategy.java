...
public class NotificationReceiverLegalFactStrategy implements ITemplateEngineStrategy {
    ...
    public String getTextToCheckLanguage(String language, String recipientType) {
        return switch (language.toUpperCase()) {
            ...
            case "TEDESCA" -> {
                yield "Gemäß Artikel 26, Absatz 11 des Gesetzesdekrets 76/2020 in geltender Fassung BESCHEINIGT PagoPA S.p.A. als rechtmäßiger Betreiber der im selben Artikel 26 genannten Plattform für digitale Zustellungen (auch bekannt als SEND - Servizio Notifiche Digitali), mit jeglicher Rechtskräftigkeit für die Entgegenhaltung gegenüber Dritten, HIERMIT, dass: am der Absender , Steuernummer dem Betreiber die elektronischen Dokumente, die mittels IUN string string string und nachfolgenden Hashes eindeutig identifizierbar sind zur Verfügung gestellt hat:string Ai sensi dell’art. 26, comma 11, del decreto-legge 76/2020 s.m.i., la PagoPA S.p.A. nella sua qualità di gestore ex lege della Piattaforma Notifiche Digitali di cui allo stesso art. 26 (anche nota come SEND - Servizio Notifiche Digitali), con ogni valore legale per l'opponibilità a terzi, ATTESTA CHE";
            }
            case "SLOVENA" -> {
