...
public class NotificationStepsV2 implements NotificationStepsInterface {
    ...
    public synchronized NewNotificationRequest convertNotificationRequest(Map<String, String> data) {
        NewNotificationRequest notificationRequestV2 = (new NewNotificationRequest()
                ...
                .addDocumentsItem(getValue(data, DOCUMENT.key) == null ? null : sharedSteps.getB2bUtils().newDocumentV20(getDefaultValue(DOCUMENT.key)))
                .pagoPaIntMode(
        ...
        NotificationRecipient notificationRecipient = (new NotificationRecipient()
                ...
                .payment(getValue(data, NotificationValue.PAYMENT.key) == null ? null : new NotificationPaymentInfo()
                                ...
                                .pagoPaForm(getValue(data, PAYMENT_PAGOPA_FORM.key) == null ?
                                        null : sharedSteps.getB2bUtils().newAttachmentV20(getDefaultValue(PAYMENT_PAGOPA_FORM.key)))
