...
public enum Destinatario {
    ...
    DESTINATARIO_ETTORE_FIERAMOSCA(ETTORE_FIERAMOSCA, MARIO_CUCUMBER_TAX_ID, PF, PEC),
    DESTINATARIO_LEONARDO_DA_VINCI(LEONARDO_DA_VINCI, LEONARDO_DA_VINCI_TAX_ID, PF, PEC),
    DESTINATARIO_GALILEO_GALILEI(GALILEO_GALILEI, GALILEO_GALILEI_TAX_ID, PF, PEC),
    // Spa
