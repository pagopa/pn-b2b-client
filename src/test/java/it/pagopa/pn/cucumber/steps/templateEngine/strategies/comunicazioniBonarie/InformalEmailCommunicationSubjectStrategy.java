...
@Component
public class InformalEmailCommunicationSubjectStrategy implements ITemplateEngineStrategy {

    private final ITemplateEngineClient templateEngineClient;
    private final TemplateEngineMessageConfigs configs;

    public InformalEmailCommunicationSubjectStrategy(ITemplateEngineClient templateEngineClient, TemplateEngineMessageConfigs configs) {
    ...
    public TemplateEngineResult retrieveTemplate(String language, boolean body, TemplateRequestContext context) {
        ...
        String file = templateEngineClient.informalEmailCommunicationSubject(selectLanguage(language), informalEmailCommunicationSubject);
        return new TemplateEngineResult(file);
    }

    @Override
    public String getTextToCheckLanguage(String language, String recipientType) {
        return String.join(" ", getYamlText("informal-email-communication-subject", recipientType, language));
    }

    @Override
    public List<String> getTextsToCheckLanguage(String language, String recipientType) {
        return getYamlText("informal-email-communication-subject", recipientType, language);
    }
