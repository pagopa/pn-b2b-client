...
public class WebhookStepsV23 implements WebhookStepsInterface {
    ...
    private ResponseEntity<List<ProgressResponseElementV23>> consumeResponseWithHttpInfo;
    ...
    public Object retrieveStreamEvent(UUID streamId) {
        return webhookClient.retrieveEventStreamV23(streamId);
    }

    @Override
    public void deleteStream(UUID streamId) {
        webhookClient.deleteEventStreamV23(streamId);
    }
    ...
    public void deleteStreamsBeforeTest(String pa) {
        List<StreamListElement> streamListElements = webhookClient.listEventStreamsV23();
    ...
    private boolean handleException(HttpStatusCodeException e, String pa, UUID streamID) {
        try {
            webhookClient.retrieveEventStreamV23(streamID);
    ...
    public void updateStreamCreatingNewRequest(UUID idStream) {
        ...
        webhookClient.updateEventStreamV23(idStream, streamRequest);
    }
    ...
    public void updateStreams() {
        ...
        streamRequest.setEventType(StreamRequestV23.EventTypeEnum.TIMELINE);
        for (StreamMetadataResponseV23 eventStream : eventStreamList) {
            StreamMetadataResponseV23 result = webhookClient.updateEventStreamV23(eventStream.getStreamId(), streamRequest);
    ...
    public void checkCorrectCancellation() {
        List<StreamListElement> streamElementList = webhookClient.listEventStreamsV23();
        for (StreamMetadataResponseV23 eventStream : eventStreamList) {
    ...
    public void getStreamById(UUID streamId) {
        StreamMetadataResponseV23 eventStream = Assertions.assertDoesNotThrow(() -> webhookClient.retrieveEventStreamV23(streamId));
    ...
    public void consumeEventStream(UUID streamId) {
        progressResponseElementList = webhookClient.consumeEventStreamV23(streamId, null);
    ...
    public void consumeEventStreamWithHttpInfo(UUID streamId) {
        consumeResponseWithHttpInfo = webhookClient.consumeEventStreamHttpV23(streamId, null);
    ...
    public void verifyNoEventsInStream() {
        ...
        assertThat(webhookClient.consumeEventStreamV23(streamId, null)).as("La lista di eventi restituiti dalla consume dovrebbe essere vuota").isEmpty();
    }
    ...
    public void createEventStream(String pa, List<String> listGroups, UUID streamIdToReplace, List<String> filteredValues, boolean forced) {
        ...
        for (StreamCreationRequestV23 request : streamCreationRequestList) {
            ...
            StreamMetadataResponseV23 eventStream = webhookClient.createEventStreamV23(request);
            if (streamIdToReplace != null) {
    ...
    public void disableStream(UUID streamId) {
        webhookClient.disableEventStreamV23(streamId);
    }
    ...
    public void disableStreams() {
        eventStreamList.forEach(s -> {
            ...
            StreamMetadataResponseV23 response = webhookClient.disableEventStreamV23(streamId);
    ...
    public Object searchTimelineElementInWebhook(String lastEventId, int deepCount, int position, AvanzamentoNotificheWebhookB2bSteps.TimelineElementSearchResult<?> timelineForStream) {
        ...
        PnPollingServiceWebhookV23 webhook = (PnPollingServiceWebhookV23) sharedSteps.getPollingFactory().getPollingService(PnPollingStrategy.WEBHOOK_V23);
        PnPollingResponseV23 pnPollingResponse = webhook.waitForEvent(sharedSteps.getNotificationIun(),
    ...
    public void getStreamEventListForStressTest() {
        for (StreamMetadataResponseV23 stream : eventStreamList) {
            ...
            List<ProgressResponseElementV23> progressResponseElements = webhookClient.consumeEventStreamV23(streamId, null);
    ...
    public List<Object> verificaCorrispondenzaElementiTimelineWebhookAndB2B() {
        ...
        TimelineElementV23 teWebhook = progressResponseElement.getElement();
        ...
        FullSentNotificationV23 fullSentNotification = getFullSentNotificationVersioned();
        it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementV23 teB2b = fullSentNotification.getTimeline().
                stream()
    ...
    public void checkCorrectDisabling(UUID streamId) {
        StreamMetadataResponseV23 eventStream = webhookClient.retrieveEventStreamV23(streamId);
