...
public class WebhookStepsV23 implements WebhookStepsInterface {
    ...
    public List<Object> verificaCorrispondenzaElementiTimelineWebhookAndB2B() {
        ...
        TimelineElementV23 timelineElement = progressResponseElement.getElement();
        ...
        FullSentNotificationV23 fullSentNotification = getFullSentNotificationVersioned();
        it.pagopa.pn.client.b2b.pa.generated.openapi.clients.externalb2bpa.model.TimelineElementV23 timelineElementB2b = fullSentNotification.getTimeline().
                stream()
