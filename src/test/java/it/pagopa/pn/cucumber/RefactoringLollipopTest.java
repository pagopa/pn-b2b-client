...
@ExcludeTags({"ignore"})
@IncludeTags({"lollipopLambdaFilterOff"})
//@IncludeTags({"lollipopLambdaFilterOn"})//TODO: scommentare in base a come è impostato il flag della lambda (Off/On)
public class RefactoringLollipopTest {
}
